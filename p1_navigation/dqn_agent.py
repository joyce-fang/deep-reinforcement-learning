...
from model import QNetwork, QNetworkPixels
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, is_ddqn=True, is_pixel=False):
        ...
        # Q-Network
        if self.is_pixel:
            self.qnetwork_local = QNetworkPixels(state_size, action_size, seed).to(device)
            self.qnetwork_target = QNetworkPixels(state_size, action_size, seed).to(device)
        else:
